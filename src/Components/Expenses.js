...
export default function Expenses() {
  ...
  return (
    <div className="expenses">
      <h1 className="center-heading">Input Your Expenses</h1>
        ...
        {showForm && (
          <form action="" method="post" id="InputForm" className="InputForm">
            ...
            <div className="buttons">
              <button onClick={SubmitForm} type="submit" className="ToggleButtton1">
                Add
              </button>
              <button onClick={toggleFormVisibility} className="ToggleButtton1">
                Cancel
              </button>
            </div>
          </form>
      ...
      <h1 className="center-heading"> Expenses Record</h1>
